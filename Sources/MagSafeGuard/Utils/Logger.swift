...
public struct Log {
    ...
    public static func critical(_ message: String, error: Error? = nil, category: LogCategory = .general) {
        let fullMessage: String
        if let error = error {
            fullMessage = "\(message): \(error.localizedDescription)"
    ...
    public static func infoPrivate(_ message: String, privateData: String, category: LogCategory = .general) {
        category.logger.info("\(message, privacy: .public): \(privateData, privacy: .private)")
    }

    /// Log with mixed public and private data
    public static func debugMixed(publicMessage: String, privateData: String, category: LogCategory = .general) {
