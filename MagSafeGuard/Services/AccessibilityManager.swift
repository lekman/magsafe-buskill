...
public class AccessibilityManager {
  ...
  public var prefersAudioDescriptions: Bool {
    ...
    UserDefaults.standard.bool(
      forKey: "com.apple.speech.synthesis.general.prefs.SpokenUIUseSpeakingHotKeyFlag")
  }
  ...
  private func handleAccessibilityChange() {
    Log.info(
      "Accessibility settings changed - VoiceOver: \(isVoiceOverEnabled), High Contrast: \(isHighContrastEnabled)",
      category: .general)
...
extension Notification.Name {
  static let accessibilityHighContrastChanged = Notification.Name(
    "accessibilityHighContrastChanged")
